{
  'variables': {
    ...
    'openssl_sources_solaris64-x86_64-gcc': [
      './config/archs/solaris64-x86_64-gcc/no-asm/crypto/params_idx.c',
      ...
      './config/archs/solaris64-x86_64-gcc/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/solaris64-x86_64-gcc/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/solaris64-x86_64-gcc/no-asm/providers/common/der/der_slh_dsa_gen.c',
