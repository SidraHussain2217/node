{
  'variables': {
    ...
    'openssl_sources_linux-elf': [
      './config/archs/linux-elf/no-asm/crypto/params_idx.c',
      ...
      './config/archs/linux-elf/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/linux-elf/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-elf/no-asm/providers/common/der/der_slh_dsa_gen.c',
