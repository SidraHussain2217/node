{
  'variables': {
    ...
    'openssl_sources_darwin64-x86_64-cc': [
      './config/archs/darwin64-x86_64-cc/no-asm/crypto/params_idx.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_ml_dsa_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_slh_dsa_gen.c',
      './config/archs/darwin64-x86_64-cc/no-asm/providers/common/der/der_wrap_gen.c',
    ],
